...
func main() {
	...
	addSeq := query.AddNewVehicle("127.0.0.1", "5001", "Test Vehicle", "44444", 0, make([]string, 1), []byte(defaultCert), []byte(defaultKey), 0, icarus.DefaultC3poTime, icarus.DefaultDaedalusTime)
